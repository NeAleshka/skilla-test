...
function Call({
                  id, callType, time, imageEmploye, fromSite,
    ...
    return (
        <li onMouseEnter={highlightCall} onMouseLeave={blurCall} style={{
            ...
            <div className='call__box'>
                ...
                <div className='call__number'>
                    <div className='call__container call__container_icon'>
                        <div style={{display: `${fromSite === 1 ? 'flex' : 'none'}`}}
                             className='call__icon call__icon_planet'></div>
                    ...
                    <div className='call__container'>
                        ...
                        <p style={{color: `${contactName !== '' ? '#5E7793' : '#122945'}`}}
                           className='call__text'>{callType === 0 ? phoneNumberIn : phoneNumberOut}</p>
            ...
            <div className='call__duration' style={!recordId ? {justifyContent: 'space-between'} : {}}>
                <p style={{display: `${isStatusDuration ? isCallActive && !isHideTime ? 'none' : isRecordActive ? 'none' : 'flex' : 'flex'}`}}
                   className='call__time call__time_duration'>{recordId === '' ? '' : roundDuration(callDuration)}</p>
